...
var rainbowJs = (function () {
    ...
    rainbowJs.initChart = function (compID) {
        ...
        var option = {series: [{name: 'data', type: 'gauge', min: 0, max: 1000, axisLine: {lineStyle: {color: [[0.20, '#66CDAA'], [0.80, '#4682B4'], [1, '#A52A2A']], width: 6, }}, axisTick: {length: 10, lineStyle: {color: 'auto', shadowBlur: 0}}, splitLine: {length: 15, lineStyle: {width: 2, color: 'auto', shadowBlur: 0}}, data: [{value: 0, name: 'Analogdata'}]}]};
